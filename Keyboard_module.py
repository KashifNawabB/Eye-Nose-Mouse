...
def draw_menu():
    ...
    cv2.line(keyboard, (int(cols / 2) - int(th_lines / 2), 0), (int(cols / 2) - int(th_lines / 2), rows),
             (51, 51, 51), th_lines)
    cv2.putText(keyboard, "LEFT", (55, 150), font, 3, (255, 255, 255), 3)
    cv2.putText(keyboard, "RIGHT", (55 + int(cols / 2), 150), font, 3, (255, 255, 255), 3)
...
while True:
    ...
    cv2.putText(board, text, (60, 100), font, 8, 0, 3)

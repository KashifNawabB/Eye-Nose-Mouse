...
board = np.zeros((250, 800), np.uint8)
board[:] = 255
...
# Keyboard settings
keyboard = np.zeros((300, 1005, 3), np.uint8)
line_th = 4  # thickness lines
rows, cols, _ = keyboard.shape
cv2.line(keyboard, ((int(cols / 2) - int(line_th / 2))+1, 0), ((int(cols / 2) - int(line_th / 2))+1, rows), (51, 51, 51), line_th)
...
def draw_letters_left(letter_index, text, letter_light=False):
    # Keys
    if letter_index == 0:
        x = 0
        y = 0
...
def draw_letters_right(letter_index, text, letter_light=False):
    # Keys
    if letter_index == 0:
        x = 500+line_th
        y = 0
...
def draw_menu():
    for i in range(15):
        ...
        draw_letters_left(i, keys_set_1[i])
        draw_letters_right(i, keys_set_2[i])
...
while True:
    ...
    if keyboard_selected == 'right':
        ...
        for i in range(15):
            if i == letter_index:
                ...
                light = False
            draw_letters_left(i, keys_set_1[i])
            draw_letters_right(i, keys_set_2[i], light)
        ...
        for i in range(15):
            ...
            if i == letter_index:
                ...
                light = False
            draw_letters_left(i, keys_set_1[i], light)
            draw_letters_right(i, keys_set_2[i])
            active_letter = keys_set_1[letter_index]
    # if frames == frames_active_letter:
    #     letter_index += 1
    ...
    cv2.putText(board, text, (60, 100), font, 5, 0, 3)
